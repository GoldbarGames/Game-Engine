...
public:
	...
	void RenderDebugRect(const SDL_Rect& targetRect, const Vector2& targetScale, 
		const Vector2& targetPivot, const glm::vec3& rotation, Color color = { 255, 255, 255, 255 }) const;
